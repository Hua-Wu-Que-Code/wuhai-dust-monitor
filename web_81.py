...
def start_http_server():
    ...
    print(f"Flask 服务器启动中，外部访问地址为 http://218.21.241.214:11009 (内部监听 {INTERNAL_IP}:11005)")
            ...
            if message == '1':
                ...
                if not started_processing:
                    ...
                    for file in os.listdir(directory):
                        ...
                        file_path = f"http://218.21.241.214:11009/polvo/{sub_directory}{nombre}_polvo.png"
...
async def start_websocket_server():
    ...
    print(f"WebSocket 服务器启动中，外部访问地址为 ws://218.21.241.214:11010 (内部监听 {INTERNAL_IP}:11007)")
